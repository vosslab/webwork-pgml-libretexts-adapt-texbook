...
avoid linking to other pages in the content, because LibreTexts has built-in TOC and any links will be broken
this is mostly a textbook/guide about programming, rather a coding project
